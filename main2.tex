...
LightGBM (global) & \textbf{0,873} & \textbf{0,856} & 0,826 \\
XGBoost (global) & -- & -- & \textbf{0,846} \\
\bottomrule
\end{tabular}
\end{table}

La degradación es además moderada: el LightGBM pierde solo 0,047 puntos de R\textsuperscript{2} entre las 24 y las 72 horas (de 0,873 a 0,826), lo que indica que el horizonte de 72 horas, el más útil para la alerta temprana por su mayor margen de actuación, sigue ofreciendo una precisión operativamente aprovechable. El XGBoost mantiene una ligera ventaja en el horizonte principal de 72 horas (R\textsuperscript{2} mediano de 0,846); su desglose a 24 y 48 horas se completará con el backtest por horizonte específico.
