...
Estos órdenes semilla no se adoptan directamente, sino que sirven de centro a una búsqueda en rejilla acotada. Conforme al criterio de control de sobreajuste descrito en la metodología, para cada combinación se registran el R\textsuperscript{2} de entrenamiento y el de validación —ambos medidos al mismo horizonte de 72 horas para que la comparación sea homogénea y no confunda el sobreajuste real con el simple aumento de dificultad del horizonte— y se calcula su diferencia relativa; se descartan las combinaciones cuya diferencia supera el 10\,\% y, entre las restantes, se selecciona la de mayor R\textsuperscript{2} de validación. La búsqueda se realiza sobre cuatro códigos postales representativos de los perfiles del EDA (industrial, mixto, residencial y de servicios) y el orden ganador se aplica de forma común a los 30 códigos postales del conjunto de evaluación, lo que garantiza una comparación homogénea y acota el coste computacional. El orden resultante es $(2,0,1)(1,1,1)_{28}$: el componente autorregresivo más parsimonioso generaliza mejor que el de orden tres, que exhibe un sobreajuste mayor en validación.
...
La optimización sigue el criterio de control de sobreajuste de la metodología (sección~III.F) mediante dos estrategias complementarias cuyos resultados completos se registran en CSV: una búsqueda en rejilla acotada (16 combinaciones de número de árboles, profundidad máxima y tasa de aprendizaje, cruzadas con dos juegos de rezagos) y una búsqueda bayesiana de 20 iteraciones implementada con Optuna~\cite{optuna2019}, que explora adicionalmente el número de hojas y la regularización L1/L2. La búsqueda bayesiana superó a la rejilla (mejor $R^2$ de validación de 0,69 frente a 0,64) y sus configuraciones ganadoras comparten una regularización L1 elevada, coherente con la separación observada entre las curvas de error de entrenamiento y validación del modelo sin ajustar. Ambas búsquedas seleccionan el juego de rezagos ampliado con \texttt{lag\_56}.
