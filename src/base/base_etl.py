...
class BaseETL(ABC):
    ...
    def __init__(self, mongo_uri:str = "mongodb://mongo:27017/", db_name:str = "tfm_energy"):
        ...
        self.logger = get_logger(self.__class__.__name__) #Crea un logger específico para cada clase que herede de BaseETL, usando el nombre de la clase como nombre del logger
